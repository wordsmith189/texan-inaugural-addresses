...
g1 <- plot_grid(p1, p2, p3, p4, p5, NULL, nrow=2)
g2 <- g1 %>% 
...
```{r printplots5-8, layout="l-body-outset", fig.height=5, fig.cap="Top 15 terms in each inaugural address by tf-idf."}
...
g3 <- plot_grid(p6, p7, p8, p9, p10, NULL, nrow=2) 
g4 <- g3 %>% 
  add_sub("www.texasenglish.org",
          x = 1, hjust = 0,
          fontfamily="Volkhov-Regular",
